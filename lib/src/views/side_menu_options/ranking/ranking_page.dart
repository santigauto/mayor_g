      ...
      child: Scaffold(
        body: Stack(
          children: <Widget>[
            ...
            Column(
              children: <Widget>[
                _cardText(text:Text('Porcentaje de respuestas correctas',style: TextStyle(color:Colors.white),)),
                Container(
                  child: PieChart(
                ...
                Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _cardText(text: Text('Preguntas respondidas',style:TextStyle(color: Colors.white))),
                        Card(
                          shape: StadiumBorder(),
                    ...
                    Column(
                      children: <Widget>[
                        _cardText(text: Text('Partidas jugadas',style:TextStyle(color: Colors.white))),
                        Card(
                          shape: StadiumBorder(),
                          color:Color(0xFF838547),
                          child:Padding(
